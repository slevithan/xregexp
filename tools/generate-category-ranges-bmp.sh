...
python parse-categories-bmp.py data/UnicodeData-6.1.0.txt > output/category-ranges-bmp.txt

# Quick hack to remove the last comma
sed -i '' -e '$s/,$//' output/category-ranges-bmp.txt

# Display the result
cat output/category-ranges-bmp.txt
