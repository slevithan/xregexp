...
(function (XRegExp) {
    ...
    XRegExp.addUnicodePackage({
        ...
        // \p{Any} matches any code unit. To match any code point via surrogate pairs, use (?:[\uD800-\uDBFF][\uDC00-\uDFFF]|[\0-\uFFFF])
        Any: "0000-FFFF", // \p{^Any} compiles to [^\u0000-\uFFFF]; [\p{^Any}] to []
        Ascii: "0000-007F",
        // \p{Assigned} is equivalent to \p{^Cn}. Could be implemented using XRegExp("[\\p{^Cn}]").source.replace(/[[\]]|\\u/g, ""), since negation inside a character class triggers inversion
