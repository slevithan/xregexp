...
module.exports = function(XRegExp) {
    ...
    XRegExp.build = function(pattern, subs, flags) {
        ...
        var inlineFlags = /^\(\?([\w$]+)\)/.exec(pattern),
            // Used with `asXRegExp` calls for `pattern` and subpatterns in `subs`. This is to work
            // around how Firefox converts '\n' to a regex that contains the literal characters `\`
            // and `n`. You can verify this by running `console.log(RegExp('\n').source)`. See more
            // details at <https://github.com/slevithan/xregexp/pull/163>
            addFlagX = flags.indexOf('x') > -1,
            data = {},
        ...
        pattern = asXRegExp(pattern, addFlagX);
