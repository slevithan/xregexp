...
(function (XRegExp) {
    ...
    // TODO: Replace with new data format
    /*XRegExp.addUnicodeData({
        ...
        Any: "0000-FFFF",
        Ascii: "0000-007F",
        // \p{Assigned} is equivalent to \p{^Cn}. Could be implemented using
        // XRegExp("[\\p{^Cn}]").source.replace(/[[\]]|\\u/g, ""), since negation inside a
        // character class triggers inversion
